"""Main Textual application for the WiFi Jammer TUI."""

from textual.app import App, ComposeResult
from textual.containers import Container
from textual.widgets import DataTable, Footer, Header, Input, Label, Log, Button
...
from wifi_jammer.core.interfaces import AttackConfig, IAttackStrategy, NetworkInfo, AttackType
from wifi_jammer.attacks.base_attack import AttackStats
from wifi_jammer.tui_screens import (
    AttackConfigScreen,
    AttackScreen,
    NetworkTable,
    ScanScreen,
