...
from wifi_jammer.core.interfaces import AttackConfig, ILogger
...
class ProgressMonitorWidget(QWidget):
    ...
    def start_monitoring(self, config: AttackConfig, attack=None) -> None:
    ...
    def _update_display(self) -> None:
        ...
        if self.current_attack and hasattr(self.current_attack, '_stats'):
            stats = self.current_attack._stats
