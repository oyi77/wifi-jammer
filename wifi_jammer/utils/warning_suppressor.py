...
class WarningSuppressor:
    ...
    @staticmethod
    def suppress_tripledes_warnings() -> None:
        ...
        warnings.filterwarnings(
            "ignore", message=".*has been moved to cryptography.hazmat.decrepit.*"
        )
        warnings.filterwarnings(
            "ignore", message=".*will be removed from this module.*"
        )
    ...
    @staticmethod
    def modern_warning_suppression() -> None:
