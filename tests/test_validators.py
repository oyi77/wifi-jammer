...
class TestInterfaceNameValidation(unittest.TestCase):
    ...
    def test_invalid_interface_names(self):
        ...
        for name in invalid_names:
            self.assertFalse(
                is_valid_interface_name(name), f"Should be invalid: {name}"
            )
...
class TestChannelValidation(unittest.TestCase):
    ...
    def test_valid_channels_2_4ghz(self):
        ...
        for channel in range(1, 15):
            self.assertTrue(
                is_valid_channel(channel, "2.4GHz"),
                f"Channel {channel} should be valid",
            )
    ...
    def test_valid_channels_5ghz(self):
        ...
        for channel in valid_5ghz:
            self.assertTrue(
                is_valid_channel(channel, "5GHz"), f"Channel {channel} should be valid"
            )
    ...
    def test_invalid_channels(self):
        ...
        for channel in invalid_channels:
            self.assertFalse(
                is_valid_channel(channel), f"Channel {channel} should be invalid"
            )
...
class TestPacketCountValidation(unittest.TestCase):
    ...
    def test_valid_packet_counts(self):
        ...
        for count in valid_counts:
            self.assertTrue(
                is_valid_packet_count(count), f"Count {count} should be valid"
            )
    ...
    def test_invalid_packet_counts(self):
        ...
        for count in invalid_counts:
            self.assertFalse(
                is_valid_packet_count(count), f"Count {count} should be invalid"
            )
